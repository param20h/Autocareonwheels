      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-6 ml-auto">
            ...
            <a href="/#services" className="text-sm font-bold text-gray-300 hover:text-white hover:-translate-y-0.5 transition-all">Services</a>
            <a href="/#how-it-works" className="text-sm font-bold text-gray-300 hover:text-white hover:-translate-y-0.5 transition-all">How it Works</a>
            <a href="/#testimonials" className="text-sm font-bold text-gray-300 hover:text-white hover:-translate-y-0.5 transition-all">Reviews</a>
